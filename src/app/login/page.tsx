      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#050d1a] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 animate-in slide-in-from-left-8 fade-in duration-1000">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-xl bg-[rgba(255,255,255,0.08)] flex items-center justify-center backdrop-blur-sm">
          ...
          <p className="text-[rgba(255,255,255,0.5)] text-sm tracking-widest uppercase font-medium ml-1">
        ...
        <div className="relative z-10 space-y-6 animate-in slide-in-from-left-8 fade-in duration-1000 delay-150">
          ...
          <div className="space-y-3">
            <p className="text-[rgba(255,255,255,0.5)] text-xs uppercase tracking-widest font-medium">
            ...
            <div className="flex flex-wrap gap-2">
              {['LandBank', 'DBP', 'PCFC', 'PhilGuarantee'].map((partner) => (
                <span
                  key={partner}
                  className="bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.1)] rounded-lg px-3.5 py-1.5 text-white/80 text-xs font-semibold"
                >
                  {partner}
                </span>
              ))}
          ...
          <blockquote className="font-display italic text-[1.4rem] leading-[1.7] text-[#e2e8f0] max-w-[380px]">
            &quot;Connecting island communities through{' '}
            <span className="text-[var(--color-teal)] font-semibold">
              transparent financing
            </span>{' '}
            and sustainable maritime infrastructure.&quot;
          </blockquote>
          <p className="text-[rgba(255,255,255,0.5)] text-sm leading-relaxed max-w-sm">
          ...
          <div className="w-full max-w-md bg-transparent border-none shadow-none p-8 rounded-2xl space-y-7 animate-in slide-in-from-bottom-8 fade-in duration-700">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  {selectedRole === 'operator' && (
                    <span className="absolute top-2.5 right-2.5 flex h-4 w-4 items-center justify-center rounded-full bg-[var(--color-teal)] animate-in zoom-in duration-200">
                      <svg
                  ...
                  <Ship className="w-8 h-8 text-[var(--color-teal)]" />
                  <div>
                    <p
                ...
                >
                  ...
                  <Landmark className="w-8 h-8 text-[var(--color-teal)]" />
                  <div>
                    <p
                      className={`text-sm font-semibold leading-tight ${
                        selectedRole === 'institution'
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs text-[var(--color-teal)] hover:opacity-80 font-medium transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <p className="text-center text-sm text-[var(--color-muted)]">
              ...
              <Link
                href="/register"
                className="text-[var(--color-teal)] hover:opacity-80 font-semibold transition-colors"
              >
            ...
            <div className="flex flex-col items-center gap-2 pt-4 border-t border-[rgba(255,255,255,0.06)]">
              ...
              <div className="flex items-center gap-3 text-[#64748b] text-[0.7rem] font-medium">
                <span className="flex items-center gap-1"><Shield className="w-3 h-3" /> SOC 2 Type II</span>
                <span>·</span>
                <span className="flex items-center gap-1"><Shield className="w-3 h-3" /> BSP Registered</span>
              </div>
            </div>
          </div>
        </div>
